...
public class UpdateBookRequest {
	...
	public UpdateBookRequest(
			...
			@JsonProperty(value = "yearIssued") Integer yearIssued, 
			@JsonProperty(value = "numberOfCopies") Integer numberOfCopies, 
			@JsonProperty(value = "authors") List<String> authors) {
